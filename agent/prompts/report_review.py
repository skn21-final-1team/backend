...
현재 단계 산출물과 워크플로우 스냅샷을 바탕으로 사용자의 피드백이 현재 단계 결과에 대한 승인,
...
판정 기준:
- 사용자가 "좋아요", "진행해", "승인", "괜찮아" "다음"처럼 다음 단계 진행 의사를 보이면 approve.
...
- 짧은 승인 표현 예: "완료", "완료.", "완료!", "완료했습니다", "끝", "ok", "오케이", "확인"
...
- 사용자 피드백이 "완료" 또는 단문 승인 표현만 포함하면 action은 반드시 approve
""".strip()
