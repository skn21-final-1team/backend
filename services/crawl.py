...
from schemas.crawl import CrawlRequestBody, CrawlNewRequest, CrawlResponse, CrawlSyncRequest, CrawlSyncResponse
...
class CrawlService:
    ...
    async def request_sync_crawl(self, body: CrawlSyncRequest) -> CrawlSyncResponse:
        try:
            async with AsyncClient(
                base_url=settings.chunking_crawl_url,
                headers={"Content-Type": "application/json"},
